// src/renderer/pages/watch-later/WatchLaterPage.tsx
import React from 'react';
import { Clock } from 'lucide-react';
import VideoGrid from '../../components/Shared/VideoGrid';
import { useInfiniteVideos } from '../../hooks/useInfiniteVideos';
import AuthGuard from '../../components/Auth/AuthGuard';
import { getWatchLaterVideos } from '../../services/watchLater';

const WatchLaterPage: React.FC = () => {
  const { videos, loading, hasMore, error, loadMore } = useInfiniteVideos(getWatchLaterVideos);
      ...
      <div className="max-w-screen-2xl mx-auto">
        ...
        {videos.length === 0 && !loading && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Watch later is empty</h2>
